...
\restrict sDJrzXNyKyk5u7ldGqcN05JaucAd6aFad87ya0atNojcz8fgnKxBcTnN32c1tdd

-- Dumped from database version 17.6 (0d47993)
-- Dumped by pg_dump version 17.6 (Debian 17.6-1.pgdg12+1)

-- Started on 2025-11-30 19:17:46 UTC
...
ALTER TABLE ONLY public.ataque ALTER COLUMN id SET DEFAULT nextval('public.ataque_id_seq'::regclass);
...
ALTER TABLE ONLY public.ataque_propiedad ALTER COLUMN id SET DEFAULT nextval('public.ataque_propiedad_id_seq'::regclass);
...
ALTER TABLE ONLY public.combo_movimiento ALTER COLUMN id SET DEFAULT nextval('public.combo_movimiento_id_seq'::regclass);
...
ALTER TABLE ONLY public.tipo_ataque ALTER COLUMN id SET DEFAULT nextval('public.tipo_ataque_id_seq'::regclass);


--
-- TOC entry 3429 (class 0 OID 139360)
-- Dependencies: 230
...
--
-- TOC entry 3427 (class 0 OID 139349)
-- Dependencies: 228
...
--
-- TOC entry 3425 (class 0 OID 139265)
-- Dependencies: 226
...
--
-- TOC entry 3431 (class 0 OID 139386)
-- Dependencies: 232
...
--
-- TOC entry 3416 (class 0 OID 16513)
-- Dependencies: 217
...
--
-- TOC entry 3417 (class 0 OID 16518)
-- Dependencies: 218
...
--
-- TOC entry 3419 (class 0 OID 16530)
-- Dependencies: 220
...
--
-- TOC entry 3421 (class 0 OID 98305)
-- Dependencies: 222
...
--
-- TOC entry 3433 (class 0 OID 204811)
-- Dependencies: 234
...
--
-- TOC entry 3423 (class 0 OID 131074)
-- Dependencies: 224
...
SELECT pg_catalog.setval('public.registro_id_seq', 80, true);
...
--
-- TOC entry 3258 (class 2606 OID 139369)
...
--
-- TOC entry 3254 (class 2606 OID 147470)
...
--
-- TOC entry 3256 (class 2606 OID 139356)
...
--
-- TOC entry 3260 (class 2606 OID 139391)
...
--
-- TOC entry 3252 (class 2606 OID 155650)
...
--
-- TOC entry 3240 (class 2606 OID 90115)
...
--
-- TOC entry 3242 (class 2606 OID 90113)
...
--
-- TOC entry 3244 (class 2606 OID 81924)
...
--
-- TOC entry 3246 (class 2606 OID 98310)
...
--
-- TOC entry 3262 (class 2606 OID 204818)
...
--
-- TOC entry 3248 (class 2606 OID 131082)
...
--
-- TOC entry 3250 (class 2606 OID 131080)
...
--
-- TOC entry 3267 (class 2606 OID 155651)
-- Name: ataque ataque_id_combo_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.ataque
    ADD CONSTRAINT ataque_id_combo_fkey FOREIGN KEY (id_combo) REFERENCES public.combo(id) ON DELETE CASCADE;


--
-- TOC entry 3268 (class 2606 OID 139370)
-- Name: ataque ataque_id_movimiento_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.ataque
    ADD CONSTRAINT ataque_id_movimiento_fkey FOREIGN KEY (id_movimiento) REFERENCES public.movimiento(id) ON DELETE CASCADE;


--
-- TOC entry 3269 (class 2606 OID 155656)
-- Name: combo_movimiento combo_movimiento_id_combo_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.combo_movimiento
    ADD CONSTRAINT combo_movimiento_id_combo_fkey FOREIGN KEY (id_combo) REFERENCES public.combo(id) ON DELETE CASCADE;


--
-- TOC entry 3270 (class 2606 OID 139397)
-- Name: combo_movimiento combo_movimiento_id_movimiento_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.combo_movimiento
    ADD CONSTRAINT combo_movimiento_id_movimiento_fkey FOREIGN KEY (id_movimiento) REFERENCES public.movimiento(id) ON DELETE CASCADE;


--
-- TOC entry 3263 (class 2606 OID 98316)
-- Name: registro fkah285er29vhjxept79dlhl4w2; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.registro
    ADD CONSTRAINT fkah285er29vhjxept79dlhl4w2 FOREIGN KEY (id_personaje_emisor) REFERENCES public.personaje(id);


--
-- TOC entry 3264 (class 2606 OID 180226)
-- Name: registro fkh6lxcq5mv9whpo3u8clktk1h6; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.registro
    ADD CONSTRAINT fkh6lxcq5mv9whpo3u8clktk1h6 FOREIGN KEY (id_ataque) REFERENCES public.ataque(id);


--
-- TOC entry 3265 (class 2606 OID 98321)
-- Name: registro fknponbfiwck9eaewokvv06yfr4; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.registro
    ADD CONSTRAINT fknponbfiwck9eaewokvv06yfr4 FOREIGN KEY (id_personaje_receptor) REFERENCES public.personaje(id);


--
-- TOC entry 3266 (class 2606 OID 98326)
-- Name: registro fks3a0l9s70k1cr6iutponq39fh; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.registro
    ADD CONSTRAINT fks3a0l9s70k1cr6iutponq39fh FOREIGN KEY (id_posicion) REFERENCES public.posicion(id);
...
-- Completed on 2025-11-30 19:17:47 UTC

--
-- PostgreSQL database dump complete
--

\unrestrict sDJrzXNyKyk5u7ldGqcN05JaucAd6aFad87ya0atNojcz8fgnKxBcTnN32c1tdd
